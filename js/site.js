...
$( document ).ready(function() {
	...
	$(document.body).on('appear', '.animateright', function(e, $affected) {
	  ...
	  $(document.body).on('appear', '.countup', function(e, $affected) {
			...
			// Count up javascript
				...
				var demo1 = new countUp("counting_elem1", 0, 3200, 0, 2, options);
				demo1.start();
				var demo2 = new countUp("counting_elem2", 0, 7200, 0, 2, options);
				demo2.start();
				var demo3 = new countUp("counting_elem3", 0, 12500, 0, 2, options);
				demo3.start();
				var demo4 = new countUp("counting_elem4", 0, 39, 0, 2, options);
				demo4.start();
	...
	$(".home").css("max-width","100%");
	  ...
	  function initialize()
		{
		var mapProp = {
		  center:new google.maps.LatLng(-22.907000,-43.1772680),
		  zoom:10,
